...
void Graphics::Initialize()
{
	...
	// SSAA (Super Sampling Anti Alliasing) : 
	// MSAA (Multi Sampling Anti Alliasing) : 
...
//						Reource View : ID3D11Texture의 용도를 명확히 해주는것
//										Ex) ID3D11RenderTargetView, ID3D11ShaderResourceView, 
//										    ID3D11DepthStencilView, ID3D11UnorderAccessView
